...
export const VALID_EMPLOYEES: ValidEmployee[] = [
  ...
  },
  {
    ...
    short: "Թագուհի",
    aliases: ["Թագուհի", "Тагуи", "Тагуги", "Taguhi"],
    active: true,
    role: "Младший бухгалтер",
  },
  {
  ...
  },
  {
    ...
    short: "Նաիրա Մ․",
    aliases: ["Նաիրա Մ․", "Նաիրա Մ.", "Նաիրա Մ", "Наира М.", "Наира М", "Naira M."],
    active: true,
    role: "Ведущий бухгалтер",
  },
  {
    ...
    short: "Հասմիկ",
    aliases: ["Հասմիկ", "Асмик", "Хасмик", "Hasmik"],
    active: true,
    role: "Бухгалтер",
  },
  {
  ...
  },
  {
    ...
    short: "Դավիթ",
    aliases: ["Դավիթ", "Давид", "Давит", "Davit", "David"],
    active: true,
    role: "Бухгалтер",
  },
  {
  ...
  },
  {
    ...
    short: "Լիլիթ Ք․",
    aliases: ["Լիլիթ Ք․", "Լիլիթ Ք.", "Լիլիթ Ք", "Лилит К.", "Лилит К", "Lilit K."],
    active: true,
    role: "Бухгалтер",
  },
  {
    ...
    short: "Արթուր",
    aliases: ["Արթուր", "Артур", "Artur", "Arthur"],
    active: true,

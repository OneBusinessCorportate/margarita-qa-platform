...
const RULES: Rule[] = [
  // --- main_taxes (Russian) -------------------------------------------------
  {
    ...
    all: [
      ...
      /(отправ|подал|подан|сдан|направил|загрузил|выгрузил|сдала|отправила|отчита|задеклар)/i,
    ],
  },
  // --- main_taxes (Armenian) ------------------------------------------------
  ...
  // --- salary (Russian) -----------------------------------------------------
  {
    ...
    all: [
      ...
      /(получ|пришл|прислал|подпис|сдал|предоставил|скинул|сбросил|прислала|получила|пришла|отправил|отправила|отправлен|отправлена|отправили|выслал|переслал)/i,
    ],
  },
  {
    category: "salary",
  ...
  // --- primary_docs (Russian) -----------------------------------------------
  {
    ...
    all: [
      ...
      /(получ|пришл|прислал|сдал|предоставил|скинул|передал|прислала|получила|пришла|отправил|отправила|отправлен|отправлена|отправили|выслал|переслал)/i,
    ],
  },
  {
    category: "primary_docs",
  ...
  },
  {
    ...
    all: [
      /(долг|задолженност)/i,
      /(позвон|звонил|звонок|обзвон|перезвон|созвон)/i,
    ],
  },
  {
    category: "debts",

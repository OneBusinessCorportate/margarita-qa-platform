...
// `last_activity_date` (last arg) is anchored to the demo "today" 2026-06-15:
// most chats are live (06-12…06-15), a few are deliberately stale to exercise
// the activity check — #19 went quiet on Wed 06-10 (Margarita's example), #102
// on 06-11, #510 weeks ago, #700 never (and is also unassigned).
export const seedChats: Chat[] = [
  chat("59", "ИП Фролкин Владимир N B-3932 RU", "23357581", "Գայանե", "30000", "https://web.telegram.org/a/#-4983666095", "2026-06-15"),
  ...
  chat("220", "ИП Никита Капишников N-220 RU", "10000220", "Ավագ", "72000", "https://web.telegram.org/a/#-4194805297", "2026-06-13"),
  chat("336", "ИП Сурбине Арушанян N-336 RU", "10000336", "Հասմիկ", "нет долга", "https://web.telegram.org/a/#-4061368619", "2026-06-15"),
  chat("368", "Норк Вью Кондоминиум N-368 RU", "10000368", "Նաիրա", "30000", "https://web.telegram.org/a/#-4520708494", "2026-06-12"),

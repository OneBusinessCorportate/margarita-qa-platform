    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Журнал QA менеджеров регистрационного отдела: одна оценка на менеджера
          в неделю. Старт 100 баллов, минус штрафы за критические ошибки,
          скорость ответа и обратную связь. Новая запись — в нижней строке.
        </p>
      </div>
      <RegistrationPanel
        managers={managers}

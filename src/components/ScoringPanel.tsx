      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
        ...
        <div className="ml-auto flex flex-wrap items-center gap-2 text-sm">
          ...
          <span
            ...
            title="Статус рассылки сохраняется каждый день и сбрасывается 28-го (новый цикл). AI анализирует сообщения бухгалтера и показывает подсказку отдельно — в строке «🤖 AI» и бейджем 🔍 под ячейкой. Ваш вчерашний статус остаётся; AI сам заполняет вашу ячейку только когда уверен (готовое действие: Отправил / Получил / Нет долга). 🔍 — нажмите, чтобы применить подсказку; ✓ — уже совпадает; 📌 — сохранено вами до 28-го."
          >
            🔍 авто-рассылки
          </span>
